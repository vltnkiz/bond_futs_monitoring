...
from market_data_feed.core.ports.market_data_feed import MarketDataFeed, TickHandler
from typing import Any, Optional

class LSEGMarketDataFeed(MarketDataFeed):
    __session: Optional[ld.Session] = None
    __stream: Optional[Any] = None
    __instruments_subscribed: set[str] = set()
    __fields_subscribed: set[str] = set()
